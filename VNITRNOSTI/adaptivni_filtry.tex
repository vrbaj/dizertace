...
\end{equation}
Pokud není podmínka splněna, pak je algoritmus nestabilní a hodnoty $\textbf{w}(k)$ divergují. Pokud je naopak velikost rychlosti učení $\mu$ příliš malá, váhy konvergují pomalu.
\par 
